...
| 功能 | 描述 |
|------|------|
| **任务管理** | 详细任务追踪，包含状态、优先级、分类、截止时间、联系人、关键字、历史记录 |
...
- **丰富任务卡片**：每个任务包含状态、优先级、分类、截止时间、联系人、关键字、历史、备注
...
├── SYSTEM_PROMPT_STANDALONE.md         # 独立版（无使用说明）
├── README.md                            # 英文说明
├── README_CN.md                         # 中文说明（本文件）
└── assistant_brain/
    ├── SOUL.md               # 身份与价值观（不变的底线）
    ├── OPERATIONAL_RULES.md  # 运营策略与决策规则
