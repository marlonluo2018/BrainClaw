...
6. **Archive old events:** Move events older than CONFIG.md "Recent Events Window" to `tasks/history/timeline_YYYY-MM.md`
...
**Process:**
1. Identify operation type from user command (see `OPERATIONAL_RULES.md` "Workflow Reference" for trigger commands)
